...
try {
    ...
    if ($configuracion && !(bool) $configuracion["notificaciones_activas"]) {
        echo json_encode([
            "exito" => true,
            "creada" => false,
            "mensaje" => "Las notificaciones están desactivadas."
        ], JSON_UNESCAPED_UNICODE);
        exit;
    }
    ...
    $tiposValidos = ["recordatorio", "racha", "progreso", "logro", "general"];
